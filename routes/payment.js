...
router.post("/create-checkout-session", authMiddleware, async (req, res) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "payment",
      line_items,
      success_url: `https://aj-electronics-frontend.vercel.app/success?session_id={CHECKOUT_SESSION_ID}&order_id=${newOrder._id}`,
      cancel_url: `https://aj-electronics-frontend.vercel.app/cancel`,
